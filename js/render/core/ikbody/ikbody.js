...
import { add, def, distance, scale, subtract } from "../cg.js";
...
export function IKBody(ik_data) {
...
IKBody.prototype = {
   ...
   getP : function(j, frame) { return this.pos[j]; },
   getQ : function(j, frame) { return this.qua[j]; },
   getPF: function(j) { return this.pos[j]; },
   getQF: function(j) { return this.qua[j]; },
      ...
      if (this.graph === undefined) {
         ...
         function IKBodyResponder() {
            ...
            this.simulate = function() {
               ...
               this.graph.nodes[IK.SHOULDER_L ].p.offset(-.1, 0, 0, this.ikBody.getQF(IK.HEAD));
