...
!(function (e, t) {
  ...
  function _(e, t, n) {
      ...
      k.extend(n, {
        options: function (t) {
          ...
          if (k.isArray(t) || k.isObject(t)) {
            ...
            return (
              n.remove(),
              p(e, n.object, n.property, { before: i, factoryArgs: [t] })
            );
          }
        },
        name: function (e) {
    ...
    n.setValue = k.compose(function (t) {
      return (
        e.getRoot().__preset_select && n.isModified() && u(e.getRoot(), !0), t
      );
    }, n.setValue);
  }
  function h(e, t) {
    ...
    Q = (function (e) {
      function t(e, n, o, i, r) {
        function a(e) {
          ...
          return (
            _.setValue(s(e.clientX, t.left, t.right, _.__min, _.__max)), !1
          );
        }
        function l() {
    ...
    k.extend(_e.prototype, {
      ...
      saveAs: function (e) {
        this.load.remembered ||
          ((this.load.remembered = {}),
          (this.load.remembered[re] = w(this, !0))),
