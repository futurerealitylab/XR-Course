...
def convert_to_quaternion(pose_mat):
    ...
    r_x = (pose_mat[2][1]-pose_mat[1][2])/(4*r_w) if r_w != 0 else 0
    r_y = (pose_mat[0][2]-pose_mat[2][0])/(4*r_w) if r_w != 0 else 0
    r_z = (pose_mat[1][0]-pose_mat[0][1])/(4*r_w) if r_w != 0 else 0
